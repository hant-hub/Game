...
static const char* TexPaths[] = {
    TEXPATH("eli/slide1.png"),
    TEXPATH("eli/slide2.png"),
    TEXPATH("eli/slide3.png"),
    TEXPATH("eli/slide4.png"),
    TEXPATH("eli/slide5.png"),
    TEXPATH("eli/slide6.png"),
    TEXPATH("eli/slide7.png"),
};
