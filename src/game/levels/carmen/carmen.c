...
static const char* TexPaths[] = {
    TEXPATH("carmen/slide3.png"),
    TEXPATH("carmen/slide4.png"),
    TEXPATH("carmen/slide5.png"),
    TEXPATH("carmen/slide1.png"),
    TEXPATH("carmen/slide2.png"),
};

void CarmenInit(GameState* state) {
...
void CarmenUpdate(GameState* state, PresentInfo* p) {
    u32 frameCounter = 0;
    double dt = 0;
    double accum = 0;
